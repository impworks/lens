...
namespace Lens.Test.Internals
{
    ...
    {
        private static readonly TypeResolver Resolver = new TypeResolver(new TypeResolutionContext(), new Dictionary<string, bool> {{"System", true}}, new ReferencedAssemblyCache());
