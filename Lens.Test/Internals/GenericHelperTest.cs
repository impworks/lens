...
namespace Lens.Test.Internals
{
    ...
    {
        public static int UnboundGeneric<T>(int a)
        {
            return a;
        }

        public static T BoundGeneric<T>(int a)
        {
            return default(T);
        }

        public static int Parametric<T>(T a, T b)
        {
            return 1;
        }

        public static Tuple<T1, T2> Deep<T1, T2>(T1 arg1, IEnumerable<T2> arg2)
        {
            return default(Tuple<T1, T2>);
        }

        public static Dictionary<Tuple<T1, T2, int>, IEnumerable<T3>> Nightmare<T1, T2, T3>(T1 a, List<Tuple<T2, bool>> b)
        {
            return null;
        }

        public static IEnumerable<T> Extension<T>(T obj, int args)
        {
            return null;
        }
    }
