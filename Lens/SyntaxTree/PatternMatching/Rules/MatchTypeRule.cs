    ...
    internal class MatchTypeRule : MatchRuleBase
    {
        ...
        public override IEnumerable<PatternNameBinding> Resolve(Context ctx, TypeEntry expressionType)
        {
            ...
            try
            {
                ...
                var field = ctx.ResolveField(_type.Materialize(), "Tag");
        ...
        protected bool Equals(MatchTypeRule other)
        {
            return Equals(Identifier, other.Identifier) && Equals(LabelRule, other.LabelRule);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((MatchTypeRule) obj);
        }
