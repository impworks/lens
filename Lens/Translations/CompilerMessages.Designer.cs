...
namespace Lens.Translations {
    ...
    public class CompilerMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Variable &apos;{0}&apos; cannot be closured, because the containing method &apos;{1}&apos; is an iterator!.
        /// </summary>
        public static string ClosureIterator {
            get {
                return ResourceManager.GetString("ClosureIterator", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Result of the constant expression overflows its type!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Delegates of types &apos;{0}&apos; and &apos;{1}&apos; cannot be combined because their signatures are incompatible!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Iterator method&apos;s return type must be an IEnumerable&lt;T&gt;!.
        /// </summary>
        public static string IteratorReturnTypeIncorrect {
            get {
                return ResourceManager.GetString("IteratorReturnTypeIncorrect", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot invoke function &apos;{0}&apos; because it is reserved for internal purposes..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot define a function named &apos;{0}&apos; because it is reserved for internal purposes..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Type &apos;{0}&apos; cannot be used in the script due to safe mode settings!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Type &apos;{0}&apos; already has a field named &apos;{1}&apos;!.
        /// </summary>
        public static string TypeFieldExists {
            get {
                return ResourceManager.GetString("TypeFieldExists", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Type &apos;{0}&apos; already has a property named &apos;{1}&apos;!.
        /// </summary>
        public static string TypePropertyExists {
            get {
                return ResourceManager.GetString("TypePropertyExists", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Type &apos;{0}&apos; must be prepared before its entities can be resolved!.
        /// </summary>
        public static string TypeUnprepared {
            get {
                return ResourceManager.GetString("TypeUnprepared", resourceCulture);
            }
        }
        ...
        ///   Looks up a localized string similar to Type &apos;{0}&apos; is not iterable!.
        /// </summary>
        public static string YieldFromNotIterable {
            get {
                return ResourceManager.GetString("YieldFromNotIterable", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Yield statements are not allowed in pure functions!.
        /// </summary>
        public static string YieldFromPure {
            get {
                return ResourceManager.GetString("YieldFromPure", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Yield statements are not allowed in lambda expressions!.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Yield statements are only allowed within functions!.
        /// </summary>
        public static string YieldInMain {
            get {
                return ResourceManager.GetString("YieldInMain", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Yield statements are not allowed in try blocks!.
        /// </summary>
        public static string YieldInTry {
            get {
                return ResourceManager.GetString("YieldInTry", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Type &apos;{0}&apos; cannot be yielded from an iterator of type &apos;{1}&apos;!.
        /// </summary>
        public static string YieldTypeMismatch {
            get {
                return ResourceManager.GetString("YieldTypeMismatch", resourceCulture);
            }
        }
    }
}
