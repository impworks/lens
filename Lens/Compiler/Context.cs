...
namespace Lens.Compiler
{
	...
	internal partial class Context
	{
		...
		{
			// pass 1 : load nodes & register obvious cases
			loadNodes(nodes);
			prepareEntities();

			// pass 2 : prepare scopes, find closured variables
			processClosures();
			prepareEntities();

			// pass 3 : based on prepared scopes, emit autogenerated methods & classes
			analyzeNodes();
			createAutoEntities();
			processClosures();
			prepareEntities();

			// pass 4 : emit actual code into method bodies
			compileCore();
			finalizeAssembly();
